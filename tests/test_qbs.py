...
from qbs.config import (
    ...
    RSI2Params, VixBreakerParams, VolTargetParams, ResidualMomentumParams,
)
...
def test_rank_score_none_is_bit_identical_to_the_plain_ranker():
    """Generalising the ranker must not move the shipped strategy."""
    uni, safe = _mom_fixture()
    p = MomentumParams()
    a = cross_sectional_momentum(uni, safe, p)
    b = cross_sectional_momentum(uni, safe, p, rank_score=None)
